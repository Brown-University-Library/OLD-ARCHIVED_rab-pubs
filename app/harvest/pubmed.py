...
# from harvestapi import HarvestObject

class PubMedApi(HarvestObject):

	rdf_type = namespaces.BHARVEST + "PubMedApi"

	def __init__(self, uri=None, local_name=None, id=None):
		self.prefix = prefixes.BHARVEST
		super(PubMedApi, self).__init__(uri=uri, local_name=local_name, id=id)
